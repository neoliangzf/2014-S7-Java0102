...
<script type="text/javascript">
	function confirmBuy() {
		return confirm("Determine to pay？");
	}
	function confirmDelete() {
		return confirm("Confirm to delete the order?S");
	}
</script>
</head>
<body>
	...
	<div class="container">
		<div class="check-out">
			...
			<table>
				...
				<%
					...
					if (cartList != null & cartList.size() > 0) {
						...
						for (int i = 0; i < cartList.size(); i++) {
							...
							photoPath = "images/" + goods.getGname() + ".jpg";
				...
				<tr>
					<td class="ring-in"><a
						...
						<div class="sed">
							<h5>
								Product Name：<%=goods.getGname()%></h5>
							<br>
							<!--  <p>
			...
			<a href="jsp/buyGoods.jsp" class="to-buy"
				onclick="return confirmBuy()">&nbsp;&nbsp;&nbsp;Pay&nbsp;&nbsp;&nbsp;</a>
			<%
				} else {
			%>
			<a class="to-buy">&nbsp;&nbsp;&nbsp;Pay&nbsp;&nbsp;&nbsp;</a>
			<%
				}
			%>
		</div>
